...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **P0.1** | Setup | Configurer le monorepo et l'environnement de développement (Vite, React, TypeScript). | Haute | Développeur Frontend | À faire |
| **P0.2** | Setup | Installer et configurer **Tauri v1.6.0** et le *crate* Rust associé. | Haute | Développeur Backend | À faire |
| **P0.3** | Setup | Mettre en place la structure de base de l'application (fenêtre principale, communication *frontend-backend* de base). | Haute | Développeur Fullstack | À faire |
| **P0.4** | Setup | Intégrer les bibliothèques de gestion d'état (Zustand, Jotai, Valtio). | Moyenne | Développeur Frontend | À faire |
| **P1.1** | Core Engine | Intégrer **Babylon.js v6.0.0** dans le Viewport React. | Haute | Développeur 3D | À faire |
| **P1.2** | Core Engine | Configurer le rendu 3D de base (caméra, lumière par défaut, scène vide). | Haute | Développeur 3D | À faire |
| **P1.3** | Core Engine | Intégrer et configurer **BitECS** pour la gestion des entités. | Haute | Développeur Logique | À faire |
| **P1.4** | Core Engine | Créer les composants ECS de base (`TransformComponent`, `MeshComponent`). | Haute | Développeur Logique | À faire |
| **P1.5** | Core Engine | Développer le système de rendu ECS (synchronisation BitECS -> Babylon.js). | Haute | Développeur 3D | À faire |
| **P2.1** | Core UI | Implémenter l'interface utilisateur avec les panneaux redimensionnables. | Haute | Développeur Frontend | À faire |
...
[1] Plan de Développement et Roadmap - Darkgame (Version 1.1).
[2] Spécifications Techniques Détaillées (STD) - Darkgame (Version 1.1).
